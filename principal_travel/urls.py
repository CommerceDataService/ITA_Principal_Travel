...
from travel.views import HomeView, TripDetail, TripList, trip_new, event_new, principal_new, trip_edit, trip_delete, event_edit, EventList, EventDetail, CityAutocomplete, PrincipalList, PrincipalDetail
